...
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (6, 2, 12);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (7, 1, 12);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (4, 1, 13);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (6, 1, 13);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (8, 1, 13);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (9, 1, 13);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (5, 1, 14);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (4, 1, 15);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (8, 1, 15);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (9, 1, 15);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (6, 1, 16);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (7, 1, 16);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (8, 1, 16);
INSERT INTO MYSHOP_SCHEMA.BUCKET (PRODUCT_ID, COUNT_PRODUCT, ORDER_ID) VALUES (4, 6, 17);
...
INSERT INTO MYSHOP_SCHEMA.PICTURE (NAME, PRODUCT_ID) VALUES ('2016107016256123gql0k.jpg', 4);
INSERT INTO MYSHOP_SCHEMA.PICTURE (NAME, PRODUCT_ID) VALUES ('2016107011233317igykv8.jpg', 5);
INSERT INTO MYSHOP_SCHEMA.PICTURE (NAME, PRODUCT_ID) VALUES ('201707290105481iu25qdb.jpg', 6);
INSERT INTO MYSHOP_SCHEMA.PICTURE (NAME, PRODUCT_ID) VALUES ('50390_0.jpg', 7);
INSERT INTO MYSHOP_SCHEMA.PICTURE (NAME, PRODUCT_ID) VALUES ('Newest-Mini-Syma-font-b-X20-b-font-font-b-rc-b-font-font-b-helicopter.jpg', 8);
INSERT INTO MYSHOP_SCHEMA.PICTURE (NAME, PRODUCT_ID) VALUES ('db72c5c3-6895-43dc-9940-6141a284816c.jpg', 9);
...
INSERT INTO MYSHOP_SCHEMA.PRODUCT (NAME, COUNT, COST, SIZE, BATTERY, FLY_TIME, DISTANCE, DESCRIPTION, CATEGORY_ID) VALUES ('DJI Mavic Pro WIFI 4K UHD Camera GPS Obstacle Avoidance Mini Foldable Quadcopter RTF', 5, 999.99, '31.5 x 31.5 x 6cm', '2970mAh', 27, 13000, 'The DJI Mavic Pro folds down as small as a bottle of water, making it small enough to bring with you everywhere. True 4K, fully stabilized ensures smooth footage, 4K camera is supported by a miniaturized camera stabilization system that stabilizes the entire camera, letting you extract the most from every single pixel. New OcuSync transmission system offers up to 4.3 miles (7km) of transmission range. ActiveTrack, TapFly and other smart features make professional looking video effortless. Obstacle Avoidance combined with sensor redundancy increases flight safety and reliability. Vision positioning paired with GPS and GLONASS ensures precise positioning indoor and outdoors. Fly at up to 40mph (64kmh) or for as long as 27-minutes. The DJI GO app lets you see everything the camera sees, as well as everything you need to know about your Mavic, from battery life to where it is, where it''s heading, and much more.', 3);
