...
create index ADDRESS_USER_USER_ID_fk
	on ADDRESS (USER_ID)
;
...
create index BUCKET_PRODUCT_PRODUCT_ID_fk
	on BUCKET (PRODUCT_ID)
;
...
(
	...
	constraint ORDERS_ADDRESS_ADDRESS_ID_fk
...
create index ORDERS_ADDRESS_ADDRESS_ID_fk
	on ORDERS (USER_ADDRESS_ID)
;

create index ORDERS_USER_USER_ID_fk
	on ORDERS (USER_ID)
;
...
alter table MYSHOP_SCHEMA.BUCKET
	add constraint BUCKET_PRODUCT_PRODUCT_ID_fk
...
alter table MYSHOP_SCHEMA.ADDRESS
	add constraint ADDRESS_USER_USER_ID_fk
