                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 product_img">
                                    <img src="../resources/Images/${productInCart.key.presentPic}" class="img-responsive">
                                </div>
                                <div class="col-md-6 product_content">
                                    ...
                                    <div class="btn-ground">
                                        <button type="button" value="${productInCart.key.productId}" onclick="addProductToCart(this)" class="btn btn-primary"> Add </button>
                                    </div>
                                    <div class="btn-ground">
                                        <button type="button" value="${productInCart.key.productId}" onclick="deleteProductFromCart(this)" class="btn btn-default"> Delete </button>
                                    </div>
