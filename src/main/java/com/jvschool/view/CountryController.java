...
//
//    @RequestMapping(value = "/", method = RequestMethod.GET)
//    public String goCountries(Model model) throws SQLException {
...
//
//        //Logger log = (Logger) LoggerFactory.getLogger(CountryController.class);
//
//        //log.info("hiadfasfasfasfasfasf");sssss
